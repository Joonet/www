<?xml version="1.0" encoding="utf-8"?><!--#include file="inc/AspCms_SettingClass.asp" -->
<%CheckLogin()%>
<%
sub menulist(ParentID)
	Dim rs :set rs =Conn.Exec ("select *,(select count(*) from {prefix}Sort where ParentID=t.SortID) as c from AspCms_Sort t where LanguageID="&rCookie("languageID")&" and ParentID="&ParentID&" and sorttype<>7 and sortstatus=1 order by Sortorder,Sortorder ","r1")
...
<div class="infobox">
	...
	<p>&copy;2006-2011, <A class=txt_C1  href="http://www.Chancoo.com/" target=_blank>ChanCoo</A> Inc.</p>
