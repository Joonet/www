...
switch(t)
  ...
  <TR>
    ...
    <TD><input class="input" maxlength="6" value="3" style="WIDTH: 60px" name="SortOrder"/> </TD></TR>
  <TR>
...
function SetEditorPage(EditorName, ContentStr) {
    ...
    <TD align=middle height=30 valign="top">上传图片</td>
      <td colspan="3"><input class="input" maxlength="255" style="WIDTH: 400px" id="indeximage" name="indeximage" /> <img src="../../images/help.gif" class="tTip" title="栏目图片，可在前台调用"><iframe name="image" frameborder="0" width='100%' height="40" scrolling="no" src="../../editor/upload.asp?sortType=3&stype=file&Tobj=indeximage" allowTransparency="true"></iframe></td>
    </tr>
    	<tr>
