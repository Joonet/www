...
<%Dim oFCKeditor:Set oFCKeditor = New FCKeditor:oFCKeditor.BasePath="../../editor/":oFCKeditor.ToolbarSet="AdminMode":oFCKeditor.Width="815":oFCKeditor.Height="600":oFCKeditor.Value=decodeHtml(Content):oFCKeditor.Create "Content"
