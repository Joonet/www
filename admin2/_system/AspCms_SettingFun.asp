...
Sub SavePayMent
	...
	configStr = AddParas("Payment_Online","(\S*?)",configStr,false)
	configStr = AddParas("Payment_Bank","(\S*?)",configStr,false)
	configStr = AddParas("Payment_PostOffice","(\S*?)",configStr,false)
